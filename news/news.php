...
//title
$sql = "SELECT news_title FROM news WHERE id = 1";
...
//subtitle
$sql = "SELECT news_subtitle FROM news WHERE id = 1";
mysqli_query($conn, "SET CHARACTER SET 'utf8';");
...
//image
$sql = "SELECT news_imageURL FROM news WHERE id = 1";
...
//content
$sql = "SELECT news_content FROM news WHERE id = 1";
mysqli_query($conn, "SET CHARACTER SET 'utf8';");
